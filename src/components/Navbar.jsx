...
const Navbar = () => {
  ...
  const serviceLinks = [
    ...
    { name: "All Services", path: "/serviceshome", icon: <FaCheck className="text-blue-500" /> },
      ...
      <div className="container mx-auto px-4 md:px-6 py-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center space-x-8 font-medium">
          ...
          <div className="relative">
            <button
              onClick={() => setIsServiceOpenDesktop(!isServiceOpenDesktop)}
            ...
            {isServiceOpenDesktop && (
              <ul className="absolute left-0 mt-2 w-48 bg-white shadow-lg rounded-lg py-2 z-20">
