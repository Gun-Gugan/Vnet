...
export default function ServicesHome() {
  ...
  const services = [
    ...
    { icon: <FaLaptop className="text-blue-500 text-4xl mb-4 mx-auto" />, title: "lab & Office Setup", desc: "Connect with Vnet office setup.", link: "/labOffice" },
  ];
  ...
  return (
    <div className="font-sans text-gray-800">
      ...
      <section className="container mx-auto py-24 px-4">
        <div className="text-center mb-16">
          <h6 className="text-blue-500 font-semibold mb-2 uppercase tracking-wider">
            Our Other Services
          </h6>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {OtherServices.map((p, i) => (
            ...
            >
              ...
              {/* Top-left badge — hidden on hover */}
              <div className="absolute top-4 left-4 flex bg-blue-600 bg-opacity-90 text-white text-sm font-semibold px-3 py-1 rounded-md shadow-md transition-opacity duration-300 group-hover:opacity-0">
