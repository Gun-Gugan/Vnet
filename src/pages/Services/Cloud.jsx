  ...
  return (
    <div className="font-sans text-gray-800">
      ...
      <section className="bg-gradient-to-r from-blue-50 to-indigo-50 py-20">
        <div className="container mx-auto px-4 md:px-8 flex flex-col md:flex-row items-center gap-10">
          <div className="md:w-1/2 text-center md:text-left">
            <h1 className="text-4xl sm:text-4xl lg:text-5xl font-extrabold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-red-600 to-indigo-600">
              CLOUD - AWS/AZURE
            </h1>
            <p className="text-gray-700 text-sm sm:text-lg lg:text-lg leading-relaxed">
          ...
          <div className="md:w-1/2 mt-8 md:mt-0">
            <img
              src={CloudMain}
              alt="Cloud"
              className="rounded-xl shadow-lg mx-auto w-full sm:w-3/4 md:w-full"
            />
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        ...
        <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 px-4 sm:px-6">
        ...
        <div className="container mx-auto flex flex-col-reverse md:flex-row items-center gap-12 px-6 md:px-12">
          ...
          <div className="w-full md:w-1/2 text-center md:text-left">
            ...
            <p className="text-gray-700 text-base md:text-lg leading-relaxed mb-6">
              At <span className="font-semibold text-blue-600">V Net Technology</span>,
              we specialize in AWS and Azure cloud solutions — helping organizations
              achieve seamless digital transformation through scalable, secure, and
      ...
      {/* Mission Section */}
      <section className="py-16 sm:py-20 bg-gradient-to-r from-blue-50 to-indigo-50 text-center px-4">
        <h3 className="text-3xl sm:text-4xl lg:text-4xl font-bold mb-6">
          Our Mission & Vision
        </h3>
