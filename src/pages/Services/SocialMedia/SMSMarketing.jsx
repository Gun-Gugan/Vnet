...
const whyChooseUs = [
  { icon: <FaHeartbeat />, title: "Instant Reach", description: "Contact your client instantly — most people open and read SMS in minutes." },
  { icon: <FaBriefcaseMedical />, title: "Personalized Campaigns", description: "We tailor each SMS campaign to your brand, audience, and goals." },
  { icon: <FaMapMarkerAlt />, title: "High Engagement Rates", description: "SMS advertising has some of the highest open and reaction rates in comparison to other media." },
  { icon: <FaFingerprint />, title: "Data-Driven Approach", description: "We monitor campaigns in real time, optimizing them based on performance." },
];

const features = [
  { icon: <FaCameraRetro />, title: "Instant Delivery & High Open Rates", description: "Your message is almost guaranteed to be seen within minutes." },
  { icon: <FaLeaf />, title: "Direct & Personal Communication", description: "SMS allows businesses to communicate directly with customers." },
  { icon: <FaCog />, title: "Real-Time Tracking & Analytics", description: "Advanced tracking and analytics tools monitor your SMS campaigns live." },
  { icon: <FaDatabase />, title: "Broad Reach Across Demographics", description: "Messages are delivered directly to mobile devices, reaching a wide audience." },
];

const testimonials = [
  { avatar: SMS1, title: "Personalized SMS Campaigns", description: "Personalization is key to capturing customer attention. Tailored messages for your audience." },
  { avatar: SMS2, title: "Automated SMS Marketing", description: "Save time with automated SMS campaigns across the customer journey." },
  { avatar: SMS3, title: "SMS with URL Tracking", description: "Track clicks, monitor traffic, and analyze user behavior directly from SMS." },
];
...
export default function SMSMarketing() {
  return (
    <div className="space-y-32 font-sans text-gray-800">
      ...
      {/* HERO */}
      <header className="bg-gradient-to-r from-indigo-50 via-white to-indigo-50 py-20 px-4">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8">
          <div className="lg:w-1/3 flex flex-col gap-6">
            {whyChooseUs.slice(0, 2).map((item, idx) => (
              <div key={idx} className="flex flex-col sm:flex-row items-center sm:items-start gap-4 p-6 bg-white rounded-2xl shadow-lg hover:shadow-2xl transition transform hover:-translate-y-1">
          ...
          <div className="lg:w-1/3 text-center my-6 lg:my-0">
            <img src={SMSMarketingImg} alt="SMS Illustration" className="w-3/4 sm:w-2/3 md:w-3/4 mx-auto rounded-full shadow-2xl" />
          </div>
          <div className="lg:w-1/3 flex flex-col gap-6">
          ...
          {testimonials.map((item, idx) => (
            <div key={idx} className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition transform hover:-translate-y-1 relative">
              ...
              <div className="flex flex-col sm:flex-row items-center sm:justify-between gap-4 mt-4">
                ...
                <span className="flex gap-1 text-yellow-400 justify-center">
