  ...
  return (
    <div className="space-y-32">
      ...
      <header className="bg-gradient-to-r from-pink-50 via-white to-pink-50 py-16">
        <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center gap-8 px-4 sm:px-6">
          ...
          <div className="lg:w-5/12 w-full text-center mb-6 lg:mb-0">
            <img src={HeroImg} alt="Instagram Marketing" className="rounded-xl shadow-lg w-full object-cover max-w-md mx-auto" />
          </div>
        </div>
      </header>
      ...
      <section className="container mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-8">
          ...
          <div className="text-center my-6 lg:my-0 w-full lg:w-1/3">
            <img src={MainImg} alt="Instagram Marketing" className="rounded-full w-72 sm:w-80 lg:w-96 mx-auto shadow-lg" />
          </div>
          <div className="flex flex-col gap-6 w-full lg:w-1/3">
