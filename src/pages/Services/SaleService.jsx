...
export default function SaleAndService() {
  return (
    <div className="space-y-32 font-sans text-gray-800">
      ...
      {/*     Home Banner     */}
      <section id="home" className="relative h-[500px] sm:h-[600px] md:h-[700px] lg:h-[750px]">
        <img src={MainBanner} alt="All accessories" className="w-full h-full object-cover opacity-30" />
        <div className="absolute inset-0 bg-black/40 flex items-center justify-center p-4 sm:p-6 md:p-8">
      ...
      {/*     Services     */}
      <section id="service" className="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
          {services.map((service, i) => (
            <div key={i} className="flex flex-col sm:flex-row gap-6 bg-white p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 items-start">
              {service.icon}
              <div>
      ...
      {/*     Divider     */}
      <div className="bg-indigo-50 py-16 sm:py-20 text-center px-4 sm:px-6 lg:px-8">
      ...
      {/*     Accessories     */}
      <section id="about" className="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          {accessories.map((item, i) => (
            ...
            >
              <img
                src={item.img}
                alt={item.title}
                className="w-24 sm:w-28 md:w-32 h-24 sm:h-28 md:h-32 object-contain mb-4"
              />
