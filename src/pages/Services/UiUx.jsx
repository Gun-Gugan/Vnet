          ...
          <div className="flex flex-col lg:flex-row items-center">
                ...
                {bannerContent.map((item, index) => (
                  <div key={index}>
                    ...
                    {item.paragraphs.map((para, idx) => (
                      <p key={idx} className="text-base md:text-lg text-gray-700 mb-3 leading-relaxed">
                        {para}
                      </p>
                    ))}
                  </div>
            ...
            <div className="w-full lg:w-1/2 mt-10 lg:mt-0 flex justify-center">
              <img
                src={gif}
                alt="UI/UX Designer"
                className="rounded-full w-56 md:w-64 lg:w-72 h-56 md:h-64 lg:h-72 object-cover shadow-xl hover:scale-105 transition-transform duration-500"
              />
            </div>
