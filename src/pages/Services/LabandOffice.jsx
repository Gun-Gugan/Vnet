...
const FeatureCard = ({ title, desc, img }) => (
  <div className="flex flex-col md:flex-row items-center gap-6 bg-white rounded-xl shadow-lg p-6 hover:shadow-2xl transition duration-500">
    <img src={img} alt={title} className="w-full md:w-1/2 h-64 md:h-56 lg:h-64 object-cover rounded-xl" />
  ...
  return (
    <div className="space-y-32">
      ...
      <section className="relative h-[500px] md:h-[600px] bg-gradient-to-r from-indigo-100 via-white to-indigo-100 flex items-center">
        <div className="container mx-auto flex flex-col md:flex-row items-center gap-8 px-4 sm:px-6 lg:px-8">
      ...
      {/* About Section */}
      <section className="container mx-auto flex flex-col md:flex-row items-center gap-12 py-16 px-4 sm:px-6 lg:px-8">
        <div className="md:w-1/2 w-full mb-6 md:mb-0">
          <img src={AboutImg} alt="About Company" className="rounded-xl shadow-xl w-full" />
        </div>
      ...
      {/* Office */}
      <section className="container mx-auto py-16 px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="space-y-12">
          {officeBlogs.map((blog, idx) => (
            ...
            >
              <div className="md:w-1/2 w-full">
                <img src={blog.img} alt={blog.title} className="rounded-xl shadow-xl w-full h-64 md:h-56 lg:h-64 object-cover" />
              </div>
              <div className="md:w-1/2 space-y-4">
