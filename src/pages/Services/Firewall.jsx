import HeroBg from "./assets/firewall/Vintage.jpeg";
    ...
    <div className="space-y-32">
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10 flex items-center h-full">
          <div className="max-w-3xl mx-auto lg:mx-0 text-center lg:text-left">
            ...
            <p className="text-white text-base sm:text-lg lg:text-lg leading-relaxed">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 md:px-8 text-center mb-12">
          <h2 className="text-primary font-semibold text-base sm:text-lg">Our Services</h2>
          <p className="text-3xl sm:text-4xl md:text-4xl font-bold mt-2">
            Services provided at V-Net Technologies
          </p>
        </div>

        <div className="container mx-auto px-4 md:px-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-12">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 md:px-8 flex flex-col-reverse lg:flex-row items-center gap-12">
          ...
          <div className="w-full lg:w-6/12 flex justify-center lg:justify-end">
            <img
              src={AboutImg}
              alt="About Us"
              className="rounded-2xl w-full max-w-md md:max-w-lg lg:w-full shadow-lg object-cover"
            />
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 md:px-8 text-center mb-12">
          <h2 className="text-3xl sm:text-4xl md:text-4xl font-bold">
            Why Choose V Net Technologies?
          </h2>
        </div>

        <div className="container mx-auto px-4 md:px-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10">
