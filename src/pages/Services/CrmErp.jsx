...
export default function CrmErp() {
  ...
  return (
    <div className="font-sans text-gray-800">
      ...
      {/* Welcome */}
      <section className="bg-gradient-to-b from-gray-900 to-gray-800 text-white py-20 px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-10">
            ...
            {feature.imgLeft && (
              <img
                src={feature.img}
                alt={feature.title}
                className="rounded-3xl w-full max-w-sm md:max-w-md lg:w-5/12 shadow-lg object-cover"
              />
            )}
      ...
      <section className="py-16 bg-gray-100 text-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-7">
